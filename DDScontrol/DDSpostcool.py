...
f4new = 58665337.8708-1.3e3+0.7e3+1.3e3-2.5e3	
...
fc=f4new
# updated 2017.12.07
FreqM1X = fc+ 13e3   #13.3e3-2e3   #10.2e3	# Hz, -1 sideband
FreqM2X = fc+ 27e3   #27.8e3-2e3  #22.3e3   # Hz, -2 sideband
...
FreqM2Z = fc+ 26e3   #28.4e3-2e3  #19.1e3 # Hz, -2 sideband
...
os.system('copy '+Coolfilename+' postCool')
#os.system('C:\Users\Yang\Documents\Data\DDScontrol\NewDDS2-Cooling2.0-Cal.exe Cool')
subprocess.call(['C:\Users\Yang\Documents\Data\DDScontrol\NewDDS2-Cooling2.0-Cal.exe', 'postCool'])
